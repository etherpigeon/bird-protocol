...
def test_multiple_depositors_nest_grows(alice, bob, am3crv_gauge, am3crv_nest):
    ...
    am3crv_nest.deposit_gauge_tokens(100 * 10**18, 50 * 10**18, {"from": bob})
...
def test_min_shares_revert(alice, am3crv_gauge, am3crv_nest):
    am3crv_gauge.approve(am3crv_nest, 100 * 10**18, {"from": alice})
    with brownie.reverts("dev: slippage"):
        am3crv_nest.deposit_gauge_tokens(100 * 10**18, 101 * 10**18, {"from": alice})
